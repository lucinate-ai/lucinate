...
- **Supported version floor:** Hermes `v2026.6.5` (v0.16.0 — first release with the `hermes dashboard` WS gateway); harness pinned to current stable. Verified against a live `v2026.6.5` container in the Phase 0 spike (see `phase0-fixtures.md`).
